...
import { featchSingleLeads, updateLeada } from "../../store/leads-slice";
...
const EditLead = () => {
  ...
  useEffect(() => {
    dispatch(featchSingleLeads(id)).then((res) => {
  ...
  let handleSubmit = async (e) => {
    e.preventDefault();
    dispatch(updateLeada({ formData: form, id }))
      .then((res) => {
        console.log(res);
        navigate("/leads");
      })
  ...
  return (
    <>
      <div className="max-w-2xl">
        {/* Header */}
        <div className="mb-6">
          <h2 className="text-xl font-bold text-slate-800">Edit Your Leads</h2>
          <p className="text-sm text-slate-400 mt-1">Fill the new Details</p>
        </div>
